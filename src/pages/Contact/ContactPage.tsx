        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a
                  href={`https://wa.me/${contactData.telepon_marketing.replace(/\s/g, "")}`}
                  target="_blank"
                ...
                <a
                  href={`mailto:${contactData.email}?subject=Konsultasi%20Proyek%20Konstruksi`}
                  target="_blank"
            ...
            >
              ...
              <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100 h-[450px] md:h-[500px] relative">
                ...
                {/* Map Marker Info Overlay (Persis seperti di gambar) */}
          ...
          {/* ===== 4 VALUE BANNER DI BAWAH (Persis Gambar) ===== */}
...
// ==========================================
// 3. KOMPONEN ICON CUSTOM (Karena FaUserTie & FaHandshake tidak ada di Fa6)
// ==========================================
